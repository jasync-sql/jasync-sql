...
class URLParserSpec {
    ...
    fun `create a jdbc mysql connection with the available fields` (){
      ...
      assertEquals(parse(connectionUri), Configuration(
        username = "john",
        password = "doe",
    ...
    fun `create a connection without port` (){
      ...
      assertEquals(parse(connectionUri),  URLParser.DEFAULT.copy(
        username = "john",
        password = "doe",
        database = "my_database",
        host = "128.167.54.90"
    ...
    fun `recognise a mysql uri` (){
      assertEquals(parse("mysql://localhost:425/dbname"), Configuration(
        username = "root",
        database = "dbname",
        port = 425,
        host = "localhost"
    ...
    fun `recognize a jdbc mysql uri` (){
      assertEquals(parse("jdbc:mysql://localhost:425/dbname"), Configuration(
        username = "root",
        database = "dbname",
        port = 425,
        host = "localhost"
    ...
    fun `pull the username and password from URI credentials` (){
      assertEquals(parse("jdbc:mysql://user:password@localhost:425/dbname"), Configuration(
        username = "user",
        password = "password",
        database = "dbname",
        port = 425,
    ...
    fun `pull the username and password from query string` (){
      assertEquals(parse("jdbc:mysql://localhost:425/dbname?user=user&password=password"), Configuration(
        username = "user",
        password = "password",
        database = "dbname",
        port = 425,
    ...
    fun `use the query string parameters to override URI credentials` (){
      assertEquals(parse("jdbc:mysql://baduser:badpass@localhost:425/dbname?user=user&password=password"), Configuration(
        username = "user",
        password = "password",
        database = "dbname",
        port = 425,
    ...
    fun `successfully default the port to the mysql port` (){
      assertEquals(parse("jdbc:mysql://baduser:badpass@localhost/dbname?user=user&password=password"), Configuration(
        username = "user",
        password = "password",
        database = "dbname",
        port = 3306,
