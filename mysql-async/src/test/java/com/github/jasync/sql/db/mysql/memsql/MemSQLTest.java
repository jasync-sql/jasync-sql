...
import static com.github.jasync.sql.db.mysql.memsql.MemsqlContainerHelper.defaultMemsqlConfiguration;
...
public class MemSQLTest {
	...
	private MySQLConnection setup() throws InterruptedException, ExecutionException, TimeoutException {
		return new MySQLConnection(defaultMemsqlConfiguration).connect().get(1, TimeUnit.SECONDS);
	}
