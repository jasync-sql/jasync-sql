...
public class ContainerHelper {
   ...
   */
  private static Configuration containerConfiguration = new Configuration(
      "root",
      "localhost",
      33306,
      "root",
  ...
  static {
    try {
      Connection connection = new MySQLConnection(containerConfiguration).connect().get(1, TimeUnit.SECONDS);
      ...
      try {
        Connection connection = new MySQLConnection(defaultConfiguration).connect().get(1, TimeUnit.SECONDS);
