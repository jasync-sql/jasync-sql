...
class URLParserSpec {
  ...
  fun `"postgresql URLParser" should     "recognize a jdbc_postgresql_dbname uri"`() {
    ...
    assertThat(URLParser.parse(connectionUri)).isEqualTo(URLParser.DEFAULT.copy(
        database = "dbname"
    ))
  }
  ...
  fun `"postgresql URLParser" should     "recognise a postgresql___ uri"`() {
    assertThat(URLParser.parse("postgresql://localhost:425/dbname")).isEqualTo(URLParser.DEFAULT.copy(
        username = "postgres",
        database = "dbname",
        port = 425,
        host = "localhost"
  ...
  fun `"postgresql URLParser" should     "recognise a postgres__ uri"`() {
    assertThat(URLParser.parse("postgres://localhost:425/dbname")).isEqualTo(URLParser.DEFAULT.copy(
        username = "postgres",
        database = "dbname",
        port = 425,
        host = "localhost"
  ...
  fun `"postgresql URLParser" should     "recognize a jdbc_postgresql___ uri"`() {
    assertThat(URLParser.parse("jdbc:postgresql://localhost:425/dbname")).isEqualTo(URLParser.DEFAULT.copy(
        username = "postgres",
        database = "dbname",
        port = 425,
        host = "localhost"
  ...
  fun `"postgresql URLParser" should     "pull the username and password from URI credentials"`() {
    assertThat(URLParser.parse("jdbc:postgresql://user:password@localhost:425/dbname")).isEqualTo(URLParser.DEFAULT.copy(
        username = "user",
        password = "password",
        database = "dbname",
        port = 425,
  ...
  fun `"postgresql URLParser" should     "pull the username and password from query string"`() {
    assertThat(URLParser.parse("jdbc:postgresql://localhost:425/dbname?user=user&password=password")).isEqualTo(URLParser.DEFAULT.copy(
        username = "user",
        password = "password",
        database = "dbname",
        port = 425,
  ...
  fun `"postgresql URLParser" should     "use the query string parameters to override URI credentials"`() {
    assertThat(URLParser.parse("jdbc:postgresql://baduser:badpass@localhost:425/dbname?user=user&password=password")).isEqualTo(URLParser.DEFAULT.copy(
        username = "user",
        password = "password",
        database = "dbname",
        port = 425,
  ...
  fun `"postgresql URLParser" should     "successfully default the port to the PostgreSQL port"`() {
    assertThat(URLParser.parse("jdbc:postgresql://baduser:badpass@localhost/dbname?user=user&password=password")).isEqualTo(URLParser.DEFAULT.copy(
        username = "user",
        password = "password",
        database = "dbname",
        port = 5432,
